    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-danger">
            <div class="inner">
                ...
                <h3>{{$unrefereedCompetitions->count()}}</h3>

                <p>تعداد اثر نیاز به داوری شما</p>
            </div>
            <div class="icon">
                <i class="ion ion-pie-graph"></i>
            </div>
            <a href="/referee/refereeing" class="small-box-footer">رای گیری<i class="fa fa-arrow-circle-left"></i></a>
        </div>
    </div>
