        ...
        <div class="collapse navbar-collapse" id="navbarVerticalContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link text-light" href="#">ثبت نام <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light" href="#">مدیریت</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-light" href="#">داوران</a>
                </li>
                <li class="nav-item">
